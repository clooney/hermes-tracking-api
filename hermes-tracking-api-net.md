Hermes Tracking API - .Net
================================
Use .Net to track Hermes shipments with Hermes Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "HZZADA0058353452";
                  createTrackingParams.courierCode = "hermes";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "H01PJA0067929440",
                      courierCode = "hermes"
                  };
                  ...
                  {
                      trackingNumber = "H01UUA0022088820",
                      courierCode = "hermes"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "H01PJA0067929440,H01UUA0022088820";
                  getTrackingResultsParams.courierCode = "hermes";
