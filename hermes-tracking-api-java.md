Hermes Tracking API - Java
================================
Use Java to track Hermes shipments with Hermes Tracking API.

Features
--------
- Real-time Hermes tracking.
- Batch Hermes tracking.
- Other features to manage your Hermes tracking.
...
Then, start to track your Hermes shipments.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.hermes;
    ...
    public class CreateHermesTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("HZZADA0058353452");
                createTrackingParams.setCourierCode("hermes");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateHermesTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("H01PJA0067929440");
                createTrackingParams1.setCourierCode("hermes");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("H01UUA0022088820");
                createTrackingParams2.setCourierCode("hermes");
...
Get status of the shipment:
    ...
    public class GetHermesTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("H01PJA0067929440,H01UUA0022088820");
                trackingParams.setCourierCode("hermes");
...
Update a tracking by ID:
    ...
    public class UpdateHermesTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9b72ce46f61c2bfe739ec8247f341b03";
